...
// Sign up a new user
// TODO: integrate this function with pushNewUser
...
// TODO: change this function to receive uid, as generated by the signup
...
function pushNewSubject(name, colour, is_deleted) {
    // CREATE A REFERENCE TO FIREBASE
...
function completeTask(subjectId, weekDate, taskId) {
    ...
    oldRef.once('value', function(snapshot)  {
        ...
        markAsDone(taskId);
        closeModalWindow();
    }, firebaseErrorFrom('completeTask'));
}
